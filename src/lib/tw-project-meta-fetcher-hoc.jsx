...
const API_URL = `${PM_API_ROOT}/api/v1/projects/getproject?projectID=$id&requestType=metadata`;
const API_REMIX_URL = `${PM_API_ROOT}/api/v1/projects/getremixes?projectId=$id`;
...
const TWProjectMetaFetcherHOC = function (WrappedComponent) {
        ...
        componentDidUpdate() {
            ...
            fetchProjectMeta(projectId)
                .then(data => {
                    ...
                    const authorThumbnail = `${PM_API_ROOT}/api/v1/users/getpfp?username=${data.author.username}`;
    ...
    const mapDispatchToProps = dispatch => ({
        ...
        onSetExtraProjectInfo: (accepted, isRemix, remixId, tooLarge, author, releaseDate, uploadDate, isUpdated) => dispatch(setExtraProjectInfo({
            accepted,
            isRemix,
            remixId,
            tooLarge,
